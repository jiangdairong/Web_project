			...
			if(eventdetail_id){
				...
				query.get(eventdetail_id, { 
					success: function(eventdetail){
						...
						var url = '//www.facebook.com/plugins/like.php?href=''width&amp;layout=button_count&amp;action=like&amp;show_faces=true&amp;share=true&amp;height=21&amp;appId=299735220203958';
						//var encode_url = encodeURIComponent(url);
						$('.fb_likes').attr("src",url);
