			...
			if(eventdetail_id){
				...
				query.get(eventdetail_id, { 
					success: function(eventdetail){
						...
						'<iframe src="//www.facebook.com/plugins/like.php?href='.encode_url.'width&amp;layout=button_count&amp;action=like&amp;show_faces=true&amp;share=true&amp;height=21&amp;appId=299735220203958" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:21px;" allowTransparency="true"></iframe>';
